...
import { rects } from "./codeArea"

export const HeroProgramming = (props: SVGProps<SVGSVGElement>) => (
	<motion.div
	...
	>
		...
		>
			...
			>
				{rects.map((rect) => (
					<rect key={`${rect.x}-${rect.y}`} {...rect} fill="#fff" />
				))}
			</motion.g>
			<path
				fill="#ffb6b6"
			...
			<motion.g>
				<motion.rect
					...
					height={20.846}
					animate={{
						height: [10.846, 10.846, 100.846, 10.846],
					}}
					transition={{
						times: [0, 1],
						duration: 5,
				...
				<motion.rect
					...
					animate={{
						x: [0, 0, 80, 80, 0],
						width: [180.236, 180.236, 102.236, 102.236, 180.236],
					}}
					transition={{
						times: [0, 0, 1],
						duration: 5,
